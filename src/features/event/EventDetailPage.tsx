...
import { CalendarIcon, ClockIcon, FileTextIcon, InfoIcon, MapPinIcon, QrCodeIcon, TicketIcon, UserIcon } from 'lucide-react';
...
const EventDetailPage: React.FC<EventDetailProps> = ({ eventId }) => {  
  ...
  const [availableSeats, setAvailableSeats] = useState(data?.availableSeat || 0);  
  const [error, setError] = useState('');  
  
  const handleComplete = (ticketCount: number) => {  
    setAvailableSeats(prev => prev - ticketCount);  
              ...
              <CardContent className="space-y-6 p-6">  
                ...
                <div className="space-y-3 text-sm text-gray-600">  
                  ...
                  <div className="flex items-center gap-3">  
                    ...
                    <p className="line-clamp-1"> Ticket Available: {availableSeats} Tickets</p>  
                  </div>  
                </div>  
